...
impl JumpDb {
    ...
    pub fn add(&mut self, dir: &Path) {
        ...
        // Frecency: rank increases by 1 each visit
        entry.rank += 1.0;
        entry.last_visit = now;
        // Age entries: halve rank every 24h of inactivity (applied lazily)
        self.age_entries();
    }
